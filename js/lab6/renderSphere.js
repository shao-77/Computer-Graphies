...
var canvas;
var gl;
var lightPosition = vec4.fromValues(2.0, 2.0, 2.0, 0.0);
...
var materialAmbient = vec4.fromValues(0.6, 0.0, 0.2, 1.0);
var materialDiffuse = vec4.fromValues(0.6, 1.0, 0.2, 1.0);
var materialSpecular = vec4.fromValues(0.6, 0.2, 1.0, 1.0);
